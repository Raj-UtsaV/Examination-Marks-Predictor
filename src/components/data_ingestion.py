...
class DataIngestonConf:
    train_data_path:str=os.path.join('.artifacts','train.csv')  # Constructing the file path for 'train.csv' inside the 'artifacts' folder 
...
class DataIngestion:
    def __init__(self):
        self.ingestion_config=DataIngestonConf()
